...
class SocialAssistanceController extends Controller
{
    ...
    public function index(Request $request)
    {
           ...
           return ResponseHelper::jsonResponse(true, 'Data anggota keluarga Berhasil Diambil', SocialAssistanceResource::collection($socialAssistances), 200);
        } catch(\Exception $e){
    ...
    public function getAllPaginated(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true,  'Data anggota keluarga Berhasil Diambil', PaginateResource::make($socialAssistances,SocialAssistanceResource::class), 200);
    ...
    public function store(SocialAssistanceStoreRequest $request)
    {
        ...
        try{
            ...
            return ResponseHelper::jsonResponse(true, 'Anggota Keluarga berhasil ditambahkan', new SocialAssistanceResource
            ($socialAssistance), 201);
    ...
    public function show(string $id)
    {
        ...
        return ResponseHelper::jsonResponse(false,'Kepala Keluarga tidak ditemukan', null,404);
            ...
            return ResponseHelper::jsonResponse(true,'Detail kepala keluarga berhasil diambil', new SocialAssistanceResource($socialAssistance), 200);
        }
    ...
    $socialAssistance = $this->socialAssistanceRepository->update($id, $request);
            ...
            return ResponseHelper::jsonResponse(true,'Kepala Keluarga berhasil diupdate', new SocialAssistanceResource($socialAssistance), 200);
        }  catch(\Exception $e){
        return ResponseHelper::jsonResponse(false, $e->getMessage(), null,500);
           }
    }
    ...
    $socialAssistances = $this->socialAssistanceRepository->delete($id);
            ...
            return ResponseHelper::jsonResponse(true,'Data Kepala Keluarga berhasil dihapus', new SocialAssistanceResource($socialAssistances), 200);
        }  catch(\Exception $e){
        return ResponseHelper::jsonResponse(false, $e->getMessage(), null,500);
           }
    }
